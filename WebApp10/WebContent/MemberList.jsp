...
<%
	...
	try 
	{
		...
		// 리스트를 테이블 구조로 stringBuffer에 apend 시켜가며 
...
<style type="text/css">
	...
	button {width: 320px; height: 40px; font-family: 맑은 고딕; font-weight: bold; text-align: center;}
	...
	<form action="MemberInsert.jsp" method="post" onsubmit="return formCheck()">
		<table class="table">
			...
			<tr>
				...
				<td>
					<button class="btn" id="btnAdd" type="submit">회원 삭제</button>
				</td>
				<td>
					<input type="text" name="delete" readonly="readonly">
				</td>
			</tr>
		</table>
	</form>
...
<br /><br />
<!-- <div>
	<span id="memberCount">전체 인원수 : 3명</span>
	<table class="table">
		<tr>
			<th>번호</th>
			<th>이름</th>
